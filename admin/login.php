...
$failed='';
	...
	if(isset($_POST['submit'])){
		...
		if(check_super_admin($username, $password) != 0){
			...
			$failed =false;
			if(check_admin_category($adminId)=='NDA'){
...
?>
			...
			<div class="row-fluid">
				<div class="span12 center login-header">
					<h2><img id="logo-img" src="../img/hospital.png" width="100px" />Welcome to DrugFinder (NDA)</h2>
				</div><!--/span-->
			</div><!--/row-->
			...
			<div class="row-fluid">
				...
				<?php
					if(!isset($_POST['submit'])){
						echo "NDA Admin : Please login with your Username and Password.";
					}else{
