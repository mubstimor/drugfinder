			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-user"></i> Drug Store Licenses</h2>
					...
					<div class="box-content">
						  ...
						  <tbody>
								...
								<?php								
								$select="select * from clinic c inner join clinic_license l where c.clinicId=l.clinicId";
								$i=1;
								$query = mysql_query($select) or die("cannot select data". mysql_error());	
								while($result = mysql_fetch_array($query, MYSQL_ASSOC))
								{
								echo "<tr><td class='center'>".$i."</td>" ."<td class='center'>";								
								echo $result['clinicName']."</td><td>".$result['clinicEmail']." </td><td>".$result['startDate']." to ".$result['endDate']." </td>";
