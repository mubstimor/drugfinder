			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-user"></i> Drug Stock</h2>
					...
					<div class="box-content">
						  ...
						  <tbody>
								...
								<?php								
								$select="select * from drug d inner join drug_stock s where d.drugId=s.drugId";
								$i=1;
								$query = mysql_query($select) or die("cannot select data". mysql_error());	
								while($result = mysql_fetch_array($query, MYSQL_ASSOC))
								{
								echo "<tr><td class='center'>".$i."</td>" ."<td class='center'>";								
								echo $result['drugName']."</td><td>".$result['serialNumber']." </td><td>".$result['carton_quantity']." </td><td>".$result['expiryDate']." </td>";
