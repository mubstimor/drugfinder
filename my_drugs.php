			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-user"></i> Drugs in my Store</h2>
					...
					<div class="box-content">
						  ...
						  <tbody>
								...
								<?php								
								$select="select * from drug d inner join clinic_drug cd on d.drugId=cd.drugId and cd.availability='Available' and cd.clinicId='$clientId'";
								$i=1;
